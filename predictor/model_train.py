...
def makenewcsv():
    ...
    dcols = ["Access_to_Resources","Parental_Involvement","Motivation_Level","Internet_Access","Tutoring_Sessions","Family_Income","Teacher_Quality","School_Type","Peer_Influence","Physical_Activity","Learning_Disabilities","Parental_Education_Level","Distance_from_Home","Gender"]
...
def train_and_save_models():
    ...
    for name, model in models.items():
        ...
        # Cross-validation
        scores = cross_val_score(pipeline, X_train, y_train, scoring='neg_mean_squared_error', cv=8)
